...
Kage is a static site. `index.html` contains the document structure, CSS, procedural scene construction, scroll choreography, and interaction logic. This fork adds Spatial Review 0.7.0 and a shared Three.js r160 runtime, bundled into a checked-in static asset. The original project used Three.js r149.
